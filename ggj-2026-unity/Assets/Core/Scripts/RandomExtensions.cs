...
public static class RandomExtensions
{
  ...
  public static Quaternion NextRotation(this System.Random rand)
  {
    Quaternion quat = new Quaternion(rand.NextFloat(), rand.NextFloat(), rand.NextFloat(), rand.NextFloat());
